...
def config():
    ...
    parser.add_argument('--data_path', default='data/data/Veres/alltime/fate_train.pt')
    ...
    ##########################################################################################################
    parser.add_argument('--clc', default=1, type=int)

    parser.add_argument('--train_batch', default=0.1, type=float)
    parser.add_argument('--train_clip', default=0.5, type=float)
...
def init_config(args):
    ...
    ##################################################################################
    args.out_dir = os.path.join(args.out_dir, f'seed{args.seed}', args.leaveout_t)
